...
@APICommand(name = "listNics", description = "Assigns secondary IP to NIC", responseObject = AddIpToVmNicResponse.class)
public class ListNicsCmd extends BaseListCmd {
    ...
    public void execute() throws ResourceUnavailableException, ResourceAllocationException, 
        ...
        try {
            List<? extends Nic> results = _networkService.lisNics(this);
