...
public class ListSecondaryIPToNicCmd extends BaseListCmd {
    ...
    @Parameter(name=ApiConstants.NIC_ID, type=CommandType.LONG, required = true,
        description="the ID of the nic to to list IPs")
    private Long nicId;

    @Parameter(name=ApiConstants.VIRTUAL_MACHINE_ID, type=CommandType.LONG, required = false,
