...
public class AddIpToVmNicCmd extends BaseAsyncCmd {
    ...
    public void execute() throws ResourceUnavailableException, ResourceAllocationException, 
        ...
        String SecondaryIp =  _networkService.allocateSecondaryGuestIP(_accountService.getAccount(getEntityOwnerId()),  getZoneId(), getNicId(), getNetworkId(), getIpaddress());
        ...
        if (SecondaryIp != null) {
            ...
            throw new ServerApiException(ApiErrorCode.INTERNAL_ERROR, "Failed to assign secondary ip");
        }
    }
