...
public interface RulesService {
    ...
    boolean enableStaticNat(long ipAddressId, long vmId, long networkId, boolean isSystemVm, String vmIp) throws NetworkRuleConflictException, ResourceUnavailableException;
